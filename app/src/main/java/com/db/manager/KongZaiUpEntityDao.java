...
/** 
 * DAO for table "KONG_ZAI_UP_ENTITY".
*/
public class KongZaiUpEntityDao extends AbstractDao<KongZaiUpEntity, Long> {

    public static final String TABLENAME = "KONG_ZAI_UP_ENTITY";

    /**
     * Properties of entity KongZaiUpEntity.<br/>
    ...
    public static class Properties {
        ...
        public final static Property ZhiDongJianSuDu = new Property(11, String.class, "zhiDongJianSuDu", false, "ZHI_DONG_JIAN_SU_DU");
    }


    public KongZaiUpEntityDao(DaoConfig config) {
        super(config);
    }
    
    public KongZaiUpEntityDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"KONG_ZAI_UP_ENTITY\" (" + //
                ...
                "\"ZHI_DONG_JIAN_SU_DU\" TEXT);"); // 11: zhiDongJianSuDu
    }

    /** Drops the underlying database table. */
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"KONG_ZAI_UP_ENTITY\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, KongZaiUpEntity entity) {
        stmt.clearBindings();
        ...
        String zhiDongJianSuDu = entity.getZhiDongJianSuDu();
        if (zhiDongJianSuDu != null) {
            stmt.bindString(12, zhiDongJianSuDu);
        }
    }

    @Override
    protected final void bindValues(SQLiteStatement stmt, KongZaiUpEntity entity) {
        stmt.clearBindings();
    ...
    @Override
    public KongZaiUpEntity readEntity(Cursor cursor, int offset) {
        KongZaiUpEntity entity = new KongZaiUpEntity( //
            ...
            cursor.isNull(offset + 11) ? null : cursor.getString(offset + 11) // zhiDongJianSuDu
        );
        return entity;
    }
     
    @Override
    public void readEntity(Cursor cursor, KongZaiUpEntity entity, int offset) {
        ...
        entity.setZhiDongJianSuDu(cursor.isNull(offset + 11) ? null : cursor.getString(offset + 11));
     }
    
    @Override
    protected final Long updateKeyAfterInsert(KongZaiUpEntity entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(KongZaiUpEntity entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(KongZaiUpEntity entity) {
