...
import com.example.hu.huproject.Fragment.HuiShengLunTestFragment;
import com.example.hu.huproject.Fragment.QianYinLiTestFragment;
...
//回绳轮预张力测试界面
public class HuiShengLun_TestActivity extends AppCompatActivity {
    ...
    private HuiShengLun_TestActivity instance;
    ...
    private void initView() {
        ...
        tvLeft.setText("回绳轮预张力测试");
        fragmentList.add(HuiShengLunTestFragment.newInstance(0));
