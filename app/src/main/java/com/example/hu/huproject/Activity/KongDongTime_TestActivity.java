...
//空动时间测试界面
public class KongDongTime_TestActivity extends AppCompatActivity {
    ...
    private KongDongTime_TestActivity instance;
    ...
    private void initView() {
        ...
        tvLeft.setText("空行程时间测试");
        fragmentList.add(new KongDongTimeTestFragment());
