...
import com.example.hu.huproject.Fragment.KongZaiUpTestFragment;
...
//空载向上测试界面
public class KongZaiUp_TestActivity extends AppCompatActivity {
    ...
    private KongZaiUp_TestActivity instance;
    ...
    private void initView() {
        ...
        tvLeft.setText("空载向上制动减速度测试");
        fragmentList.add(KongZaiUpTestFragment.newInstance(0));
