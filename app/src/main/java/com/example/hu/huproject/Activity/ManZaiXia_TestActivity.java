...
//满载向下测试界面
public class ManZaiXia_TestActivity extends AppCompatActivity {
    ...
    private ManZaiXia_TestActivity instance;
    ...
    private void initView() {
        ...
        tvLeft.setText("满载向下制动距离测试");
        fragmentList.add(ManZaiXiaTestFragment.newInstance(0));
