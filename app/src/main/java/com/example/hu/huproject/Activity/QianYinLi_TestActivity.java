...
//牵引力测试界面
public class QianYinLi_TestActivity extends AppCompatActivity {
    ...
    private QianYinLi_TestActivity instance;
    ...
    private void initView() {
        ...
        tvLeft.setText("牵引力测试");
        fragmentList.add(QianYinLiTestFragment.newInstance(0));
