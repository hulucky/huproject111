...
import com.example.hu.huproject.Fragment.TestParaFragment;
...
//速度与角度测试界面
public class Speed_Angle_TestActivity extends AppCompatActivity {
    ...
    private Speed_Angle_TestActivity instance;
    ...
    private void initView() {
        ...
        fragmentList.add(SpeedAngleTestFragment.newInstance(1));
