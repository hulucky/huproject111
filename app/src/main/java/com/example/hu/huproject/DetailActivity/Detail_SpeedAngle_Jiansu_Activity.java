...
import com.example.hu.huproject.Dialog.CxfxSpeedAngleJiansuDialogs;
...
public class Detail_SpeedAngle_Jiansu_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_speedangle_jiansu_);
        instance = this;
    ...
    private void initView() {
        ...
        if (speedAngleEntity.getJiansu_startTime() != null && speedAngleEntity.getJiansu_endTime() != null
                && speedAngleEntity.getJiansu_avegare_jiansudu() != null
                && speedAngleEntity.getJiansu_time() != null
                && speedAngleEntity.getJiansu_chusudu() != null && speedAngleEntity.getJiansu_mosudu() != null
                && speedAngleEntity.getJiansu_maxspeed() != null && speedAngleEntity.getJiansu_minspeed() != null) {

            jiansu_starttime = Double.parseDouble(speedAngleEntity.getJiansu_startTime());
            jiansu_endtime = Double.parseDouble(speedAngleEntity.getJiansu_endTime());
            jiansu_average_jiansudu = speedAngleEntity.getJiansu_avegare_jiansudu();
            jiansu_time = speedAngleEntity.getJiansu_time();
            jiansu_chusudu = speedAngleEntity.getJiansu_chusudu();
            jiansu_mosudu = speedAngleEntity.getJiansu_mosudu();
            jiansu_maxspeed = speedAngleEntity.getJiansu_maxspeed();
            jiansu_minspeed = speedAngleEntity.getJiansu_minspeed();
            maxSpeed = Double.parseDouble(speedAngleEntity.getMaxSpeed());
            runTimeTotal = Double.parseDouble(speedAngleEntity.getRunTimeTotal());
    ...
    public void onViewClicked() {
        CxfxSpeedAngleJiansuDialogs dialogs = new CxfxSpeedAngleJiansuDialogs();
    ...
    private OnDialogDismissListener listener = new OnDialogDismissListener() {
        ...
        public void onDialogDismiss() {
            ...
            new Handler().postDelayed(new Runnable() {
                @Override
                public void run() {
                    ScreenShot.getPic(linearJieTu, "速度与角度减速分析图_" + speedAngleEntity.getId());
                }
            }, 500);
        }
    };
