...
import com.example.hu.huproject.Dialog.CxfxSpeedAngleYunSuDialogs;
...
public class Detail_SpeedAngle_Yunsu_Activity extends AppCompatActivity {
    ...
    private String yunsuRunTime;
    private String yunsu_averageSpeed;
    private long id;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_detial_speedangle_yunsu_);
        instance = this;
    ...
    private void initView() {
        ...
        if (speedAngleEntity.getYunsu_startTime() != null && speedAngleEntity.getYunsu_endTime() != null
                && speedAngleEntity.getMaxSpeed() != null && speedAngleEntity.getRunTimeTotal() != null
                && speedAngleEntity.getYunsu_runTime() != null && speedAngleEntity.getYunsu_averageSpeed() != null) {
            xMin = Double.parseDouble(speedAngleEntity.getYunsu_startTime());
            xMax = Double.parseDouble(speedAngleEntity.getYunsu_endTime());
            maxSpeed = Double.parseDouble(speedAngleEntity.getMaxSpeed());
            runTimeTotal = Double.parseDouble(speedAngleEntity.getRunTimeTotal());
            yunsuRunTime = speedAngleEntity.getYunsu_runTime();
            yunsu_averageSpeed = speedAngleEntity.getYunsu_averageSpeed();
    ...
    private void initspeedData() {
        ...
        tvAverageSpeed.setText(yunsu_averageSpeed);//平均速度
        tvRunTime.setText(yunsuRunTime);//运行时间
    ...
    public XYMultipleSeriesDataset speedUpdateChart() {
        int startTimeDouble = (int) (xMin * 10);
        int endTimeDouble = (int) (xMax * 10);
    ...
    public void onViewClicked() {
        CxfxSpeedAngleYunSuDialogs dialogs = new CxfxSpeedAngleYunSuDialogs();
        ...
        dialogs.show(getSupportFragmentManager(), "CxFenxiYunsu");
    }
    //dialog消失时调用
    private OnDialogDismissListener listener = new OnDialogDismissListener() {
        ...
        public void onDialogDismiss() {
            ...
            new Handler().postDelayed(new Runnable() {
                @Override
                public void run() {
                    ScreenShot.getPic(linearJieTu, "速度与角度匀速分析图_" + speedAngleEntity.getId());
                }
            }, 500);
        }
    };
