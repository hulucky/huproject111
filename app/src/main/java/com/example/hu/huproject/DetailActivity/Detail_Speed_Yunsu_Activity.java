...
import com.example.hu.huproject.Dialog.CxFenxiYunSuDialogs;
...
public class Detail_Speed_Yunsu_Activity extends AppCompatActivity {
    ...
    private Detail_Speed_Yunsu_Activity activity;
    private long id;//匀速分析的主键id

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_detial__speed__yunsu_);
        instance = this;
        activity = this;
    ...
    private void initView() {
        ...
        if (speedEntity.getYunsu_startTime() != null && speedEntity.getYunsu_endTime() != null
                && speedEntity.getMaxSpeed() != null && speedEntity.getRunTimeTotal() != null
                && speedEntity.getYunsu_runTime() != null && speedEntity.getYunsu_averageSpeed() != null) {
            xMin = Double.parseDouble(speedEntity.getYunsu_startTime());
            xMax = Double.parseDouble(speedEntity.getYunsu_endTime());
            maxSpeed = Double.parseDouble(speedEntity.getMaxSpeed());
            runTimeTotal = Double.parseDouble(speedEntity.getRunTimeTotal());
            yunsuRunTime = speedEntity.getYunsu_runTime();
            yunsu_averageSpeed = speedEntity.getYunsu_averageSpeed();
...
//                @Override
//                public void run() {
//                    ScreenShot.shoot(activity, "匀速分析图_" + id, 0);
//                }
//            }, 500);
    ...
    public void onViewClicked() {//重新分析点击事件
        //显示dialog
        CxFenxiYunSuDialogs dialogs = new CxFenxiYunSuDialogs();
    ...
    private OnDialogDismissListener listener = new OnDialogDismissListener() {
        ...
        public void onDialogDismiss() {
            ...
            new Handler().postDelayed(new Runnable() {
                @Override
                public void run() {
                    ScreenShot.getPic(linearJieTu, "速度匀速分析图_" + speedEntity.getId());
                }
            }, 500);
        }
    };
