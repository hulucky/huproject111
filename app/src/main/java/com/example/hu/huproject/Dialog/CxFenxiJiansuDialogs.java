...
public class CxFenxiJiansuDialogs extends DialogFragment {
        ...
        switch (view.getId()) {
            ...
            case R.id.btn_sure:
                ...
                if (begin.equals("") || end.equals("")) {
                    ...
                    speedEntity.setJiansu_startTime(begin);
                    speedEntity.setJiansu_endTime(end);
                    speedEntity.setJiansu_avegare_jiansudu(df2.format(averageJianSudu));
                    speedEntity.setJiansu_time(df2.format(jianSuTime));
                    speedEntity.setJiansu_chusudu(df2.format(chuSudu_jianSu));//减速初速度
                    speedEntity.setJiansu_mosudu(df2.format(moSudu_jianSu));//减速末速度
                    speedEntity.setJiansu_maxspeed(df2.format(maxSpeed_jianSudu));//减速过程中最大速度
                    speedEntity.setJiansu_minspeed(df2.format(minSpeed_jianSudu));//减速过程中最小速度
