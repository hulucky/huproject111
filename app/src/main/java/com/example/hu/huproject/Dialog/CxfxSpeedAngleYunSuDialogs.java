...
//重新分析匀速dialog
public class CxfxSpeedAngleYunSuDialogs extends DialogFragment {
        ...
        switch (view.getId()) {
            ...
            case R.id.btn_sure:
                ...
                if (begin.equals("") || end.equals("")) {
                    ...
                    speedAngleEntity.setYunsu_startTime(begin);
                    speedAngleEntity.setYunsu_endTime(end);
                    speedAngleEntity.setYunsu_runTime(yunSuRunTime);
                    speedAngleEntity.setYunsu_averageSpeed(averageSpeed);
