...
public class JiansuDialogs extends DialogFragment {
...
//                                view3.setLayoutParams(params);
                            ...
                            if (!etBegin.getText().toString().equals("") && !etEnd.getText().toString().equals("")) {
                                ...
                                int v12 = (int) (v1 * 10);
                                int v22 = (int) (v2 * 10);
                                double maxSpeed_JianSudu = 0;//减速段的最大速度
                                double minSpeed_JianSudu = 10000;//减速段的最小速度
                                double jianSuTime;//减速时间
                                double chuSudu_jianSu;//初速度
                                double moSudu_jianSu;//末速度
                                double averageJianSudu;//平均减速度
                                jianSuTime = v2 - v1;
                                try {
                                    if (v2 > v1) {
                                        ...
                                        if (speed_jsonArray_get1 != null && speed_jsonArray_get1.length() > 0) {
                                            ...
                                            tvAverageJianSpeed.setText(df2.format((chuSudu_jianSu - moSudu_jianSu) / jianSuTime));
        ...
        switch (view.getId()) {
            ...
            case R.id.btn_sure:
                ...
                if (begin.equals("") || end.equals("")) {
                    ...
                    MyApp.startTime_JianSu = begin;
                    MyApp.endTime_JianSu = end;
