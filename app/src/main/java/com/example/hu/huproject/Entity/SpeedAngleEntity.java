...
public class SpeedAngleEntity {
    ...
    public String toString() {
        return "SpeedAngleEntity{" +
                ...
                ", maxAngle='" + maxAngle + '\'' +
                ", yunsu_startTime='" + yunsu_startTime + '\'' +
                ", yunsu_endTime='" + yunsu_endTime + '\'' +
                ", yunsu_runTime='" + yunsu_runTime + '\'' +
                ", yunsu_averageSpeed='" + yunsu_averageSpeed + '\'' +
                ", jiansu_startTime='" + jiansu_startTime + '\'' +
                ", jiansu_endTime='" + jiansu_endTime + '\'' +
                ", jiansu_avegare_jiansudu='" + jiansu_avegare_jiansudu + '\'' +
                ", jiansu_time='" + jiansu_time + '\'' +
                ", jiansu_chusudu='" + jiansu_chusudu + '\'' +
                ", jiansu_mosudu='" + jiansu_mosudu + '\'' +
                ", jiansu_maxspeed='" + jiansu_maxspeed + '\'' +
                ", jiansu_minspeed='" + jiansu_minspeed + '\'' +
                '}';
    }

    @Generated(hash = 1639970172)
    public SpeedAngleEntity(Long id, long key, String runSpeed, String maxSpeed, String time,
            String point_speed, String runTimeTotal, String point_angle, String maxAngle,
            String yunsu_startTime, String yunsu_endTime, String yunsu_runTime,
            String yunsu_averageSpeed, String jiansu_startTime, String jiansu_endTime,
            String jiansu_avegare_jiansudu, String jiansu_time, String jiansu_chusudu,
            String jiansu_mosudu, String jiansu_maxspeed, String jiansu_minspeed) {
        this.id = id;
        this.key = key;
    ...
    @Generated(hash = 1513502525)
    public SpeedAngleEntity() {
    }
    ...
    public String getPoint_angle() {
        return this.point_angle;
    }

    public void setPoint_angle(String point_angle) {
        this.point_angle = point_angle;
    }
