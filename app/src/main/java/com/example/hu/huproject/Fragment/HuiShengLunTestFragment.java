...
//回绳轮测试的测试界面
public class HuiShengLunTestFragment extends ListFragment {
    ...
    TextView btnSave;
    private HuiShengLunFragmentVp1 vp1;
    private boolean isRunning = false;
    private SerialControl comA;//串口
    private boolean isConnected = false;//传感器是否连接

    //实例化自己，可以从外部传参
    public static HuiShengLunTestFragment newInstance(int position) {
        HuiShengLunTestFragment testFragment = new HuiShengLunTestFragment();
    ...
    protected void initView() {
        ...
        vp1 = HuiShengLunFragmentVp1.newInstance(0);
    ...
    protected int setLayoutId() {
        return R.layout.fragment_huishenglun_test;
    }
