...
//牵引力测试的测试界面
public class QianYinLiTestFragment extends ListFragment {
    ...
    private QianYinLiFragmentVp1 vp1;
    private SerialControl comA;//串口
    private boolean isConnected = false;//传感器是否连接

    //实例化自己，可以从外部传参
    public static QianYinLiTestFragment newInstance(int position) {
        QianYinLiTestFragment testFragment = new QianYinLiTestFragment();
    ...
    protected void initView() {
        ...
        vp1 = QianYinLiFragmentVp1.newInstance(0);
    ...
    protected int setLayoutId() {
        return R.layout.fragment_qianyinli_test;
    }
    ...
    public void onDestroy() {
        super.onDestroy();
        MyApp.isRunning = false;//清零时需要判断此时是否处于测试状态
        svLali.destroy();
        comA.close();
    }
